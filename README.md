...
Morse is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to Morse
...
- 🌐 [Live Demo](https://hieudoanm.github.io/morse/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/morse/)
- 💻 [CLI](https://github.com/hieudoanm/morse/releases)
- 📱 [Mobile](https://github.com/hieudoanm/morse/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/morse/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/morse/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/morse/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/morse/releases/tag/windows-latest)
